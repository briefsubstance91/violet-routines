...
BADGES = [
    ...
    {'id': 'first-step',   'name': 'First Step',      'desc': 'Complete your first routine',  'emoji': '✨', 'img': '/static/badges/cinnamoroll-lollipop.png',    'bg': '#ede9fe', 'ring': '#9b87f5', 'type': 'days',  'threshold': 1},
    {'id': 'spark',        'name': 'Getting Going',    'desc': '3 days completed',             'emoji': '🔥', 'img': '/static/badges/mymelody-wave.png',           'bg': '#fef3c7', 'ring': '#f59e0b', 'type': 'days',  'threshold': 3},
    {'id': 'week-warrior', 'name': 'Week of Wins',     'desc': '7 days completed',             'emoji': '⭐', 'img': '/static/badges/cinnamoroll-cherries.png',    'bg': '#d1fae5', 'ring': '#10b981', 'type': 'days',  'threshold': 7},
    {'id': 'fortnight',    'name': 'Fortnight Hero',   'desc': '14 days completed',            'emoji': '👑', 'img': '/static/badges/pompompurin-pancakes.png',   'bg': '#dbeafe', 'ring': '#3b82f6', 'type': 'days',  'threshold': 14},
    {'id': '3-week',       'name': '3-Week Wonder',    'desc': '21 days completed',            'emoji': '💜', 'img': '/static/badges/cinnamoroll-beret.png',       'bg': '#ede9fe', 'ring': '#7c3aed', 'type': 'days',  'threshold': 21},
    {'id': 'month',        'name': 'Month Marvel',     'desc': '30 days completed',            'emoji': '🏆', 'img': '/static/badges/cinnamoroll-parfait.png',     'bg': '#fce7f3', 'ring': '#ec4899', 'type': 'days',  'threshold': 30},
    {'id': 'diamond',      'name': 'Diamond Legend',   'desc': '60 days completed',            'emoji': '💎', 'img': '/static/badges/kuromi-leopard.png',          'bg': '#cffafe', 'ring': '#06b6d4', 'type': 'days',  'threshold': 60},
    # ── Routine badges ──
    {'id': 'morning-5',    'name': 'Morning Magic',    'desc': 'Morning routine ×5',           'emoji': '☁️', 'img': '/static/badges/cinnamoroll-cinnamonroll.png', 'bg': '#fef9c3', 'ring': '#eab308', 'type': 'routine', 'routine': 'am', 'threshold': 5},
    {'id': 'morning-20',   'name': 'Rise & Shine',     'desc': 'Morning routine ×20',          'emoji': '🌅', 'img': '/static/badges/gudetama.png',                'bg': '#fef9c3', 'ring': '#f59e0b', 'type': 'routine', 'routine': 'am', 'threshold': 20},
    {'id': 'afternoon-5',  'name': 'Afternoon Ace',    'desc': 'Afternoon routine ×5',         'emoji': '🌸', 'img': '/static/badges/cinnamoroll-milkshake.png',   'bg': '#fce7f3', 'ring': '#ec4899', 'type': 'routine', 'routine': 'af', 'threshold': 5},
    {'id': 'evening-5',    'name': 'Bedtime Boss',     'desc': 'Evening routine ×5',           'emoji': '🖤', 'img': '/static/badges/cinnamoroll-witch.png',       'bg': '#ede9fe', 'ring': '#7c3aed', 'type': 'routine', 'routine': 'pm', 'threshold': 5},
    {'id': 'evening-20',   'name': 'Dream Keeper',     'desc': 'Evening routine ×20',          'emoji': '🌙', 'img': '/static/badges/kuromi-wink.png',             'bg': '#ede9fe', 'ring': '#9b87f5', 'type': 'routine', 'routine': 'pm', 'threshold': 20},
    {'id': 'triple-crown', 'name': 'Triple Crown',     'desc': 'All 3 routines in one day',   'emoji': '👑', 'img': '/static/badges/cinnamoroll-flying.png',      'bg': '#fef3c7', 'ring': '#f59e0b', 'type': 'triple',  'threshold': 1},
    {'id': 'triple-7',     'name': 'Triple Threat',    'desc': 'All 3 routines on 7 days',    'emoji': '🌟', 'img': '/static/badges/cinnamoroll-dj.png',          'bg': '#fef3c7', 'ring': '#f59e0b', 'type': 'triple',  'threshold': 7},
    {'id': 'triple-30',    'name': 'Perfect Day Pro',  'desc': 'All 3 routines on 30 days',   'emoji': '💯', 'img': '/static/badges/pompompurin-icecream.png',    'bg': '#fce7f3', 'ring': '#ec4899', 'type': 'triple',  'threshold': 30},
    # ── Level Up badges ──
